...
export class RegistryClient {
    ...
    constructor(config?: RegistryConfig) {
        this.skillsUrl = config?.skillsUrl ?? 'https://raw.githubusercontent.com/open-agent-studio/hub/main';
        // We are using the exact same repo for plugins now, just a different top-level folder
        this.pluginsUrl = config?.pluginsUrl ?? 'https://raw.githubusercontent.com/open-agent-studio/hub/main';
    }
